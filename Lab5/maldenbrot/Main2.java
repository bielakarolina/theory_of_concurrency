...
public class Main2 extends JFrame {
    ...
    private final int Tasks = 100;
    //private final int NumberOfThreads = 2; //tyle wątków co rdzeni
    //private final int NumberOfThreads = 100; // dwa razy więcej wątków niż rdzeni
    ...
    public Main2() throws InterruptedException, ExecutionException {
